/*
    ...
    all the odd terms in this series form a Fibonacci series and
    ...
    The Nth term that is calculated by the program should be written to STDOUT. Other than the value of Nth term,
